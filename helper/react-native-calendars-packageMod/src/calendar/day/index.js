...
const Day = React.memo((props) => {
    const { date, marking, dayComponent, markingType, currentDate } = props;
    ...
    return (
        //@ts-expect-error
        <Component {...props} accessibilityLabel={getAccessibilityLabel} {...dayComponentProps} currentDate={currentDate}>
