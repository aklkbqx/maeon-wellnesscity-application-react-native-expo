...
const BasicDay = (props) => {
    const { theme, date, onPress, onLongPress, markingType, marking, state, disableAllTouchEventsForDisabledDays, disableAllTouchEventsForInactiveDays, accessibilityLabel, children, testID, currentDate } = props;
    ...
    const getTextStyle = () => {
        ...
        } else if (isDisabled || shouldDisableDay()) {
