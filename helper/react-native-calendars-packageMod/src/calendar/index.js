...
import { page, isGTE, isLTE } from '../dateutils';
...
function getState(day, currentMonth, currentDate, props) {
    const { minDate, maxDate, disabledByDefault, disableAllTouchEventsForDisabledDays } = props;
        ...
        return (
            <View style={style.current.dayContainer} key={id}>
                <Day
                    ...
                    date={dateString}
                    state={getState(new Date(day), new Date(currentMonth), new Date(currentDate), props)}
